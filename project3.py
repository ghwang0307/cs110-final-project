...
#print(tix_per_dist)
#other = 0
#for x in tix_per_dist.values():
    #if x < 0:
        #other += x
    #else:
        #x = x * .01
#inverted_tix_per_dist = {}
#for (x,y) in tix_per_dist.items():
    #inverted_tix_per_dist[y] = inverted_tix_per_dist.get(y, []) + [x]

#badlist = []
#for x in inverted_tix_per_dist:
        #if x < 0:
            #del inverted_tix_per_dist[x]
#print(inverted_tix_per_dist)
