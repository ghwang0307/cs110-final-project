...
#Author: Daniel Ramirez, Sam Currans, Gyumin Hwang
#Date: 05/01/2019
#E-mail: danielramirezarb@tamu.edu, ghwang0307@tamu.edu, sam_currans@tamu.edu
#Description: Project Option 2, Netflix-Movie-Tracker, This program outputs statistics involving a CSV file that contains movies and their attributes that on Netflix.
...
genre_list=convert_to_list('Genre')
...
def main():
    ...
    input('Press Enter to show the next graph')
    q4graph()
    input('Press Enter to show the final graph')
    q5graph()
main()
